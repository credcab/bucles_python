...
# inicio = ....
# fin = ....
inicio = int(input('Ingresar el primer número de la secuencia\n'))
fin = int(input('Ingresar el último número de la secuencia\n'))
...
print('el valor promedio entre los números ingresados es ', promedio)
